    ...
    servizi: collection({
      ...
      schema: {
        ...
        icona: fields.select({
          ...
          description: 'Scegli l\'icona da mostrare nella card del servizio. Questa icona apparirà automaticamente nel sito.',
          ...
          options: [
            ...
            { label: 'Scopa / Spazzolatrice (Diserbo Meccanico)', value: 'mdi:broom' },
            { label: 'Albero', value: 'mdi:tree' },
            { label: 'Pino / Conifera', value: 'mdi:pine-tree' },
            { label: 'Freccia in su (Lavori in Quota)', value: 'mdi:arrow-up-bold' },
            { label: 'Trattore (Disboscamento)', value: 'mdi:tractor' },
            { label: 'Documento / Perizia (Valutazioni)', value: 'mdi:file-document-outline' },
            { label: 'Badge (Personale Qualificato)', value: 'mdi:badge-account' },
            { label: 'Camion (Logistica / Smaltimento)', value: 'mdi:truck' },
            { label: 'Riciclo (Cippatura)', value: 'mdi:recycle' },
            { label: 'Escavatore (Scavi / Movimento Terra)', value: 'mdi:excavator' },
            { label: 'Goccia d\'acqua (Irrigazione)', value: 'mdi:water' },
            { label: 'Insetto (Disinfestazione)', value: 'mdi:bug' },
            { label: 'Tavolozza (Allestimenti / Design)', value: 'mdi:palette' },
            { label: 'Martelletto (Consulenza / CTU)', value: 'mdi:gavel' },
            { label: 'Tocco Accademico (Formazione)', value: 'mdi:school' },
            { label: 'Tagliaerba', value: 'mdi:lawn-mower' },
            { label: 'Fiore', value: 'mdi:flower-outline' },
            { label: 'Annaffiatoio', value: 'mdi:watering-can' },
            { label: 'Pala / Vanga', value: 'mdi:shovel' },
            { label: 'Germoglio / Nuova Pianta', value: 'mdi:seedling' },
            { label: 'Forbici / Cesoie (Potatura)', value: 'mdi:scissors-cutting' },
            { label: 'Staccionata / Recinzione', value: 'mdi:fence' },
            { label: 'Elmetto (Sicurezza sul Cantiere)', value: 'mdi:hard-hat' },
            { label: 'Attrezzi da lavoro', value: 'mdi:tools' },
            { label: 'Sole (Resistenza al clima / Meteo)', value: 'mdi:white-balance-sunny' },
            { label: 'Mano con germoglio (Cura / Sostenibilità)', value: 'mdi:hand-water' },
          ]
        }),
